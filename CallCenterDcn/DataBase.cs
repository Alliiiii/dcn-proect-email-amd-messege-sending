...
namespace CallCenterDcn
{
    class DataBase
    {
        public OleDbConnection Con = new OleDbConnection(@"Provider=Microsoft.Jet.OLEDB.4.0;Data Source=C:\Users\123\Desktop\CallCenterDcn\CallCenterDcn\bin\Debug\dbDCN.mdb");
        int a;
        OleDbCommand cmd;
